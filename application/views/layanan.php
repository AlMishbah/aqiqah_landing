    ...
    <header id="header-wrap">
      ...
      <div class="container-fluid">
          <div class="row mt-5">
              ...
              <div class="col-md-6">
                  <div class="card-header text-center bg-info text-black-50">Layanan</div>
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $lay->judul_layanan ?></td>
                                <td><?= $lay->deskripsi ?></td>
                                <td onclick="javascript: return confirm('anda yakin hapus')"><?= anchor('Layanan/hapus/'.$lay->id, '<div class="btn btn-danger">hapus</div>') ?>
                                <td><?= anchor('layanan/edit/' . $lay->id, '<div class="btn btn-primary">Edit</div>') ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
          ...
          <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="judul_layanan" placeholder="masukkan judul" required class="form-control">
